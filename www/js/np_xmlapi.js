...
var notdienstplan = null;

function loadNotdienstplan() {
	
	var d = $.Deferred();
	
	if(typeof notdienstplan != 'object') {
		console.log("Notdienstplan scheint bereits geladen..");
		d.resolve(notdienstplan);
	} else {
		console.log("Lade Notdienstplan ..");
	}
}
